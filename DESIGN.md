...
| 2026-09-24 | **El disparador del Menú se lee como lo que es — REVOCA D-I11 (icono) y afina D-I16 (rótulo)** | El `Menú` de la topbar pierde los tres puntos (`MoreHorizontal`) y gana **marco**: `Menú` + chevron dentro de un borde neutro (`border-border-main`), misma caja, mismo alto y mismo chevron que `Exportar`, que conserva su tinte de acento. Dos motivos. **Uno**: sin marco era texto suelto al lado de un botón con caja, y no se leía como desplegable — el chevron solo no basta cuando el vecino sí tiene contorno. **Dos**: el icono se eligió en 2026-09-22 porque el rótulo desaparecía en los anchos pequeños, y esa premisa ya no vale — el rótulo va ahora en **todos** los anchos. Medido a 375 px: el disparador pasa de ~55 a **71 px** y la barra sigue en **73 px de alto**, sin tercera fila, porque los 16 px salen de la obra, que es quien cede al truncar (regla de 2026-09-23). Con el rótulo puesto siempre, el icono no añadía nada que no dijera ya la palabra «Menú». Abierto, el disparador se queda con el fondo `bg-elevated` y el chevron girado, que es lo único que lo distingue del reposo. Petición del usuario, 2026-09-24 |
