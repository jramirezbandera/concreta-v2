...
interface Props {
  ...
  setField: <K extends keyof IsolatedFootingInputs>(field: K, value: IsolatedFootingInputs[K]) => void;
}
    ...
    <div className="flex items-center justify-between py-0.75 max-lg:min-h-11 gap-2">
      ...
      <select
        ...
        onChange={(e) => {
          ...
          setField(field, (isNaN(asNum) ? raw : asNum) as IsolatedFootingInputs[typeof field]);
        }}
