...
export function AnejoModule() {
  ...
  /** Las que se pueden rehacer: falta su PDF y la pieza se deja abrir. */
  const sinPdfLista = anejo.piezas.filter((p) => sinPdf.has(p.id) && noAbrible(p) === null);
        ...
        <main className="min-w-0 flex-1 overflow-y-auto">
          <div className="mx-auto w-full max-w-[880px] px-3 pb-6 pt-1 sm:px-5">
            ...
            <ListaPiezas
              ...
              onReconstruir={(pieza) => reconstruir([pieza])}
              onMover={mover}
              onIncluir={incluir}
