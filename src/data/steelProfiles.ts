...
const HEA_DATA: Array<[number, number, number, number, number, number, number, number, number, number, number, number, number]> = [
  // size,  h,   b,   tf,  tw,  r,   A,    Iy,    Iz,   Wpl_y, Wel_y, It,   Iw
  [100,   96, 100,  8.0, 5.0, 12, 21.2,   349,   134,    83.0,  72.8, 5.24,    2581],
  [120,  114, 120,  8.0, 5.0, 12, 25.3,   606,   231,   119,   106,   5.99,    6472],
  [140,  133, 140,  8.5, 5.5, 12, 31.4,  1033,   389,   174,   155,   8.13,   15060],
