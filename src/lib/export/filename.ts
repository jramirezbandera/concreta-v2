...
/** Los de «Incendio» (DB SI 6): la memoria, y el cuadro de resistencia al fuego del plano. */
export const INCENDIO_FALLBACK_DOCX = 'resistencia-al-fuego.docx';
export const INCENDIO_FALLBACK_PDF = 'resistencia-al-fuego.pdf';
export const INCENDIO_FALLBACK_XLSX = 'resistencia-al-fuego.xlsx';
export const INCENDIO_FALLBACK_DXF = 'resistencia-al-fuego.dxf';
