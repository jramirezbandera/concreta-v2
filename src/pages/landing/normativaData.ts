...
export const NORM_BLOCKS: NormBlock[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      { code: '§6', desc: 'Elementos de contención — empuje activo, pasivo, reposo', mod: 'Muros · Escollera' },
      { code: '§6.3', desc: 'Comprobaciones del muro — vuelco, deslizamiento, hundimiento', mod: 'Muros · Escollera' },
